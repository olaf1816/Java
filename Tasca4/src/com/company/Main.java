...
public class Main {
    ...
    private static final String MSG_DNI = "Introduce el DNI:";
    private static final String MSG_SUBJECT = "Introduce la asignatura:";
    private static final String MSG_ID_TEACHER = "Introduce el identificador de professor:";
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Asignatura: " + new_teacher.getID_Teacher());
        System.out.println(MSG1);
